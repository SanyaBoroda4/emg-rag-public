...
The original README body, kept verbatim as reference (moved here in WO21 when the README was rewritten for a two-minute read): model choices, canonical business definitions, running the eval, observability, known constraints and outstanding work.
