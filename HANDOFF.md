...
> prior context) fully up to speed. Last updated: 2026-09-17, after WO17 (conversational follow-ups; restart pending) and WO16 (Phase 7: served at https://rag.emgcheckbot.us)
...
- **Phase 7 ✅ — the RAG is served at https://rag.emgcheckbot.us** (WO16,
  ...
  - **⚠ WO17 (2026-09-17) shipped conversational follow-ups but the service
    was not restarted** — run `systemctl restart emg-rag-api` to serve them
    (the page then shows "Interpreted as: …" under follow-up answers).
