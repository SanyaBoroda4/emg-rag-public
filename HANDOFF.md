...
> prior context) fully up to speed. Last updated: 2026-09-21, after WO21 (portfolio polish), WO20 (correctness pass; restart pending), WO19 (public mirror audit; Part 3 decision pending), WO18 (dark console restyle; restart pending), WO17 (conversational follow-ups; live) and WO16 (Phase 7: served at https://rag.emgcheckbot.us)
...
- **Phase 7 ✅ — the RAG is served at https://rag.emgcheckbot.us** (WO16,
  ...
  - **⚠ WO19 (2026-09-21): the public repo's HISTORY still contains customer
    data.** Do not run the old sync; the new `scripts/sync_public.sh` only adds
    snapshot commits and will not clean history. Part 3 decision (recreate vs
    filter-repo) is Alex's: see `docs/wo19_public_audit.md`, section 5.
